...
argparse = argparse.ArgumentParser(description="Constructive heuristic method for the linear ordering problem")
argparse.add_argument("--instance", type=str, help="Path to the instance file")
argparse.add_argument("--method", type=str, choices=METHODS.keys(), help="Constructive heuristic method to use")
